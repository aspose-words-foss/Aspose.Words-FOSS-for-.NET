...
{
    /// <summary>
    /// Represents a markdown BoldInline block.
    /// </summary>
    internal class BoldInlineBlock : ContainerBlock
    {
        /// <summary>
        ...
        {
            get { return BlockType.BoldInline; }
        }
        ...
        internal const string UnderscoreDelimiter = "__";
    }
}
