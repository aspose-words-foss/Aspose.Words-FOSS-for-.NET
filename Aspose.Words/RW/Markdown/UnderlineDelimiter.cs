...
{
    /// <summary>
    /// Represents a markdown Underline delimiter.
    /// </summary>
    internal class UnderlineDelimiter : EmphasesDelimiterBase
    {
        /// <summary>
        /// Creates a UnderlineDelimiter object from a delimiter run.
        /// </summary>
        public UnderlineDelimiter(DelimiterRun delimiterRun, int offset) : base(delimiterRun, offset)
        {
        }
        ...
        {
            return new UnderlineInlineBlock();
        }
        ...
        {
            // The length of Underline delimiter cannot be less than 2.
        ...
        {
            get { return DelimiterType.Underline; }
        }
