...
{
    internal class HtmlH2ElementDef : HtmlElementDef
    {
        internal HtmlH2ElementDef(bool applyFormattingAsMsWord)
        {
            ...
            CssDeclarationCollectionBuilder cssDeclarations)
        {
            CssValue fontSize = mApplyFormattingAsMsWord
                ? new CssLengthValue(18, CssUnit.Pt)
                : new CssLengthValue(1.5, CssUnit.Em);
