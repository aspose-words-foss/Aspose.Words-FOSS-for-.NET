...
{
    internal class HtmlH3ElementDef : HtmlElementDef
    {
        internal HtmlH3ElementDef(bool applyFormattingAsMsWord)
        {
            ...
            CssDeclarationCollectionBuilder cssDeclarations)
        {
            CssValue fontSize = mApplyFormattingAsMsWord
                ? new CssLengthValue(13.5, CssUnit.Pt)
                : new CssLengthValue(1.17, CssUnit.Em);
