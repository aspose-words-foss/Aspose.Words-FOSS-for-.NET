...
{
    internal class HtmlSubElementDef : HtmlElementDef
    {
        internal HtmlSubElementDef(bool applyFormattingAsMsWord)
        {
            ...
            CssDeclarationCollectionBuilder cssDeclarations)
        {
            ...
            cssDeclarations.AddOrReplace(new CssSpecifiedDeclaration("vertical-align", CssValue.Sub));
