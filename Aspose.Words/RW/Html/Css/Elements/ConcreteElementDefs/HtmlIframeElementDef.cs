...
{
    internal class HtmlIframeElementDef : HtmlElementDef
    {
        protected override void ApplyStyles(IHtmlElementProvider element, CssDeclarationCollectionBuilder cssDeclarations)
        {
            ...
            string frameborderAttributeValue = element.GetAttributeValue("frameborder", string.Empty).ToLowerInvariant();
            if ((frameborderAttributeValue == "0") || (frameborderAttributeValue == "no"))
            {
            ...
            switch (element.GetAttributeValue("align", string.Empty).ToLowerInvariant())
            {
                ...
                case "bottom":
                    ...
                    break;
                default:
                    // Other values of the 'align' attribute are ignored.
                    break;
            }
