...
namespace Aspose.Words.Fields
{
    ...
    /// </remarks>
    public class FieldPrintDate : Field, IFieldCodeTokenInfoProvider, IFieldWithCalendar
    {
        ...
        private static DateTimeConstant GetResultInternal(Document document, CalendarType calendarType)
        {
            ...
            return new DateTimeConstant(
                DateTimeUtil.ToLocalTime(document.BuiltInDocumentProperties.LastPrinted),
                calendarType);
        }
        ...
        internal static IFieldInfoResultProvider FieldInfoResultProvider = new PrintDateInfoResultProvider();

        private class PrintDateInfoResultProvider : IFieldInfoResultProvider
        {
