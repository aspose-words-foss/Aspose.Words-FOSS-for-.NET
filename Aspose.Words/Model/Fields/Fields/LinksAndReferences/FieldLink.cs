...
namespace Aspose.Words.Fields
{
    ...
    /// source file.
    /// </remarks>
    public class FieldLink : Field, IFieldCodeTokenInfoProvider
    {
        /// <summary>
        ...
        {
            get { return FieldCodeCache.HasSwitch(AutoUpdateSwitch); }
            set { FieldCodeCache.SetSwitch(AutoUpdateSwitch, value); }
        }
        ...
        /// </summary>
        public string FormatUpdateType //int
        {
            get { return FieldCodeCache.GetSwitchArgumentAsString(FormatUpdateTypeSwitch); }
            set { FieldCodeCache.SetSwitchAsInt32(FormatUpdateTypeSwitch, value); }
        }
        ...
        internal const int ProgIdArgumentIndex = 0;
        [CodePorting.Translator.Cs2Cpp.CppConstexpr]
        internal const int SourceFullNameArgumentIndex = 1;
        [CodePorting.Translator.Cs2Cpp.CppConstexpr]
        internal const int SourceItemArgumentIndex = 2;

        internal const string AutoUpdateSwitch = "\\a";
        internal const string InsertAsBitmapSwitch = "\\b";
        internal const string IsLinkedSwitch = "\\d";
        internal const string FormatUpdateTypeSwitch = "\\f";
        internal const string InsertAsHtmlSwitch = "\\h";
        internal const string InsertAsPictureSwitch = "\\p";
        internal const string InsertAsRtfSwitch = "\\r";
        internal const string InsertAsTextSwitch = "\\t";
        internal const string InsertAsUnicodeSwitch = "\\u";
    }
}
