...
namespace Aspose.Words.Fields
{
    ...
    public class FieldNumChars : Field
    {
        ...
        {
            return new Int32Constant(document.BuiltInDocumentProperties.Characters);
        }

        internal static IFieldInfoResultProvider FieldInfoResultProvider = new NumCharsInfoResultProvider();

        private class NumCharsInfoResultProvider : IFieldInfoResultProvider
        {
