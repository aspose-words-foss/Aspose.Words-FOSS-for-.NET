...
namespace Aspose.Words.Fields
{
    ...
    /// </summary>
    /// <remarks>
    /// Retrieves, and optionally sets, the comments relating to the current document, as recorded in the <see cref="BuiltInDocumentProperties.Comments"/> property
    ...
    public class FieldComments : Field
    {
        ...
        internal static IFieldInfoResultProvider FieldInfoResultProvider = new CommentsInfoResultProvider();

        private class CommentsInfoResultProvider : IFieldInfoResultProvider
        {
