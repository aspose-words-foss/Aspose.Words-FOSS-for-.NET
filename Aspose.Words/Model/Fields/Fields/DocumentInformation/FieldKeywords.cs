...
namespace Aspose.Words.Fields
{
    ...
    public class FieldKeywords : Field
    {
        ...
        internal static IFieldInfoResultProvider FieldInfoResultProvider = new KeywordsInfoResultProvider();

        private class KeywordsInfoResultProvider : IFieldInfoResultProvider
        {
