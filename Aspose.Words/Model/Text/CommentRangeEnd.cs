...
namespace Aspose.Words
{
    ...
    /// 
    /// <p><see cref="CommentRangeEnd"/> is an inline-level node and can only be a child of <see cref="Paragraph"/>.</p>
    /// 
    /// <seealso cref="Comment"/>
    /// <seealso cref="CommentRangeStart"/>
    /// </remarks>
    public sealed class CommentRangeEnd : Node, IDisplaceableByCustomXml, INodeWithAnnotationId
    {
        /// <summary>
        /// Initializes a new instance of this class.
        /// </summary>
        /// <remarks>
        /// <p>When <see cref="CommentRangeEnd"/> is created, it belongs to the specified document, but is not
        /// yet part of the document and <see cref="Node.ParentNode"/> is <c>null</c>.</p>
        ///
        /// <p>To append a <see cref="CommentRangeEnd"/> to the document use InsertAfter or InsertBefore
        ...
        /// <summary>
        /// Returns <see cref="Words.NodeType.CommentRangeEnd"/>.
        /// </summary>
        public override NodeType NodeType
        {
            get { return NodeType.CommentRangeEnd; }
        }
        ...
        /// </summary>
        /// <remarks>
        /// <p>Calls <see cref="DocumentVisitor.VisitCommentRangeEnd"/>.</p>
        ...
        {
            return VisitorActionToBool(visitor.VisitCommentRangeEnd(this));
        }
