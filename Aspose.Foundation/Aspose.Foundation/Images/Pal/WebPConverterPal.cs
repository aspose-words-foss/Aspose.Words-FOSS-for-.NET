...
namespace Aspose.Images.Pal
{
    ...
    internal static class WebPConverterPal
    {
        ...
        private static void LoadSkiaSharp()
        {
            ...
            {
                throw new CantCreateBitmapException("SkiaSharp cannot be loaded. Make sure SkiaSharp (version 3.119.0 or higher) is referenced in your project and placed next to the Aspose.Words assembly.");
            }
#endif
        }
