...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class IntToObjDictionary<TValue>
        where TValue : class
    {
        /// <summary>
        /// Initializes a new instance of the IntToObjDictionary&lt;int, TValue&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public IntToObjDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the IntToObjDictionary&lt;int, TValue&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public IntToObjDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the IntToObjDictionary&lt;int, TValue&gt; class that contains elements copied from the specified 
        /// IntToObjDictionary&lt;int, TValue&gt;.
        /// </summary>
        public IntToObjDictionary(IntToObjDictionary<TValue> dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the IntToObjDictionary&lt;int, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the IntToObjDictionary&lt;int, TValue&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the IntToObjDictionary&lt;int, TValue&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the IntToObjDictionary&lt;int, TValue&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the IntToObjDictionary&lt;int, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the IntToObjDictionary&lt;int, TValue&gt;. Throws, if the specified key has already
        ...
        /// <summary>
        /// Removes the value with the specified key from the IntToObjDictionary&lt;int, TValue&gt;.
        ...
        /// </summary>
        private static bool CompareKeys(int key1, int key2)
        {
            return key1 == key2;
        }
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the IntToObjDictionary&lt;int, TValue&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the values in the IntToObjDictionary&lt;int, TValue&gt;. Do not use this when the value of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use IntToObjDictionary&lt;int, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the IntToObjDictionary&lt;int, TValue&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(IntToObjDictionary<TValue> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the IntToObjDictionary&lt;int, TValue&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the IntToObjDictionary&lt;int, TValue&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly IntToObjDictionary<TValue> mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of values in a IntToObjDictionary&lt;int, TValue&gt;.
        /// </summary>
        private class ValueEnumeration : IEnumerable<TValue>
        {
            ...
            /// Ctor.
            /// </summary>
            internal ValueEnumeration(IntToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the values in a IntToObjDictionary&lt;int, TValue&gt;.
            /// </summary>
            private class ValueEnumerator : IEnumerator<TValue>
            {
                ...
                /// Ctor.
                /// </summary>
                internal ValueEnumerator(IntToObjDictionary<TValue> dictionary)
                {
        ...
        private readonly int mDefaultKey;
