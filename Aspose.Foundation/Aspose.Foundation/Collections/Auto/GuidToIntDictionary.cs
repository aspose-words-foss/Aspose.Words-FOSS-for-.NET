...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class GuidToIntDictionary
    {
        /// <summary>
        /// Initializes a new instance of the GuidToIntDictionary&lt;Guid, int&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public GuidToIntDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the GuidToIntDictionary&lt;Guid, int&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public GuidToIntDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the GuidToIntDictionary&lt;Guid, int&gt; class that contains elements copied from the specified 
        /// GuidToIntDictionary&lt;Guid, int&gt;.
        /// </summary>
        public GuidToIntDictionary(GuidToIntDictionary dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the GuidToIntDictionary&lt;Guid, int&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the GuidToIntDictionary&lt;Guid, int&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the GuidToIntDictionary&lt;Guid, int&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the GuidToIntDictionary&lt;Guid, int&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the GuidToIntDictionary&lt;Guid, int&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the GuidToIntDictionary&lt;Guid, int&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(Guid key, int value, bool add)
        {
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the GuidToIntDictionary&lt;Guid, int&gt;.
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the GuidToIntDictionary&lt;Guid, int&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the GuidToIntDictionary&lt;Guid, int&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(GuidToIntDictionary dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the GuidToIntDictionary&lt;Guid, int&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the GuidToIntDictionary&lt;Guid, int&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly GuidToIntDictionary mDictionary;
