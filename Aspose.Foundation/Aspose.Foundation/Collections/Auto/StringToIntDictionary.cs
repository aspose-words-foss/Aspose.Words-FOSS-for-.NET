...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class StringToIntDictionary
    {
        /// <summary>
        /// Initializes a new instance of the StringToIntDictionary&lt;string, int&gt; class that is empty and has the default initial capacity.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToIntDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the StringToIntDictionary&lt;string, int&gt; class that is empty and has the specified initial capacity.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToIntDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the StringToIntDictionary&lt;string, int&gt; class that contains elements copied from the specified 
        /// StringToIntDictionary&lt;string, int&gt;.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToIntDictionary(StringToIntDictionary dictionary)
        ...
        /// <summary>
        /// Initializes a new instance of the StringToIntDictionary&lt;string, int&gt; class that is empty, has the default initial capacity
        /// and uses either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToIntDictionary(bool isCaseSensitive)
            : this()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the StringToIntDictionary&lt;string, int&gt; class that is empty, has the specified initial capacity
        /// and uses either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToIntDictionary(int capacity, bool isCaseSensitive)
            : this(capacity)
        {
            mIgnoreCase = !isCaseSensitive;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the StringToIntDictionary&lt;string, int&gt; class that contains elements copied from the specified 
        /// StringToIntDictionary&lt;string, int&gt; using either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToIntDictionary(StringToIntDictionary dictionary, bool isCaseSensitive)
        ...
        /// <summary>
        /// Adds the specified key and value to the StringToIntDictionary&lt;string, int&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the StringToIntDictionary&lt;string, int&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the StringToIntDictionary&lt;string, int&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the StringToIntDictionary&lt;string, int&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the StringToIntDictionary&lt;string, int&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the StringToIntDictionary&lt;string, int&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(string key, int value, bool add)
        {
            CheckKeyNotNull(key);
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the StringToIntDictionary&lt;string, int&gt;.
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the StringToIntDictionary&lt;string, int&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the keys in the StringToIntDictionary&lt;string, int&gt;. Do not use this when the key of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use StringToIntDictionary&lt;string, int&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the StringToIntDictionary&lt;string, int&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(StringToIntDictionary dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the StringToIntDictionary&lt;string, int&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the StringToIntDictionary&lt;string, int&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly StringToIntDictionary mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of keys in a StringToIntDictionary&lt;string, int&gt;.
        /// </summary>
        private class KeyEnumeration : IEnumerable<string>
        {
            ...
            /// Ctor.
            /// </summary>
            internal KeyEnumeration(StringToIntDictionary dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the keys in a StringToIntDictionary&lt;string, int&gt;.
            /// </summary>
            private class KeyEnumerator : IEnumerator<string>
            {
                ...
                /// Ctor.
                /// </summary>
                internal KeyEnumerator(StringToIntDictionary dictionary)
                {
