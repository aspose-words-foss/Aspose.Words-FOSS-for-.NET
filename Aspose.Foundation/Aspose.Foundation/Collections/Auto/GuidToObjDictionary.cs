...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class GuidToObjDictionary<TValue>
        where TValue : class
    {
        /// <summary>
        /// Initializes a new instance of the GuidToObjDictionary&lt;Guid, TValue&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public GuidToObjDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the GuidToObjDictionary&lt;Guid, TValue&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public GuidToObjDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the GuidToObjDictionary&lt;Guid, TValue&gt; class that contains elements copied from the specified 
        /// GuidToObjDictionary&lt;Guid, TValue&gt;.
        /// </summary>
        public GuidToObjDictionary(GuidToObjDictionary<TValue> dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the GuidToObjDictionary&lt;Guid, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the GuidToObjDictionary&lt;Guid, TValue&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the GuidToObjDictionary&lt;Guid, TValue&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the GuidToObjDictionary&lt;Guid, TValue&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the GuidToObjDictionary&lt;Guid, TValue&gt;.
        /// </summary>
        ...
        /// </summary>
        private int FindEntry(Guid key)
        {
            if (mBuckets != null)
            {
        ...
        /// <summary>
        /// Inserts the specified key and value to the GuidToObjDictionary&lt;Guid, TValue&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(Guid key, TValue value, bool add)
        {
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the GuidToObjDictionary&lt;Guid, TValue&gt;.
        ...
        /// </summary>
        private static int GetHashCode(Guid key)
        {
        ...
        /// </summary>
        private static bool CompareKeys(Guid key1, Guid key2)
        {
            return key1 == key2;
        }
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the GuidToObjDictionary&lt;Guid, TValue&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the values in the GuidToObjDictionary&lt;Guid, TValue&gt;. Do not use this when the value of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use GuidToObjDictionary&lt;Guid, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the GuidToObjDictionary&lt;Guid, TValue&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(GuidToObjDictionary<TValue> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the GuidToObjDictionary&lt;Guid, TValue&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the GuidToObjDictionary&lt;Guid, TValue&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly GuidToObjDictionary<TValue> mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of values in a GuidToObjDictionary&lt;Guid, TValue&gt;.
        /// </summary>
        private class ValueEnumeration : IEnumerable<TValue>
        {
            ...
            /// Ctor.
            /// </summary>
            internal ValueEnumeration(GuidToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the values in a GuidToObjDictionary&lt;Guid, TValue&gt;.
            /// </summary>
            private class ValueEnumerator : IEnumerator<TValue>
            {
                ...
                /// Ctor.
                /// </summary>
                internal ValueEnumerator(GuidToObjDictionary<TValue> dictionary)
                {
        ...
        private readonly Guid mDefaultKey;
