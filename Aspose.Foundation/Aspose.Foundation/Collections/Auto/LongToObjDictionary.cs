...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class LongToObjDictionary<TValue>
        where TValue : class
    {
        /// <summary>
        /// Initializes a new instance of the LongToObjDictionary&lt;long, TValue&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public LongToObjDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the LongToObjDictionary&lt;long, TValue&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public LongToObjDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the LongToObjDictionary&lt;long, TValue&gt; class that contains elements copied from the specified 
        /// LongToObjDictionary&lt;long, TValue&gt;.
        /// </summary>
        public LongToObjDictionary(LongToObjDictionary<TValue> dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the LongToObjDictionary&lt;long, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the LongToObjDictionary&lt;long, TValue&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the LongToObjDictionary&lt;long, TValue&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the LongToObjDictionary&lt;long, TValue&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the LongToObjDictionary&lt;long, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the LongToObjDictionary&lt;long, TValue&gt;. Throws, if the specified key has already
        ...
        /// <summary>
        /// Removes the value with the specified key from the LongToObjDictionary&lt;long, TValue&gt;.
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the LongToObjDictionary&lt;long, TValue&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the values in the LongToObjDictionary&lt;long, TValue&gt;. Do not use this when the value of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use LongToObjDictionary&lt;long, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the LongToObjDictionary&lt;long, TValue&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(LongToObjDictionary<TValue> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the LongToObjDictionary&lt;long, TValue&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the LongToObjDictionary&lt;long, TValue&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly LongToObjDictionary<TValue> mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of values in a LongToObjDictionary&lt;long, TValue&gt;.
        /// </summary>
        private class ValueEnumeration : IEnumerable<TValue>
        {
            ...
            /// Ctor.
            /// </summary>
            internal ValueEnumeration(LongToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the values in a LongToObjDictionary&lt;long, TValue&gt;.
            /// </summary>
            private class ValueEnumerator : IEnumerator<TValue>
            {
                ...
                /// Ctor.
                /// </summary>
                internal ValueEnumerator(LongToObjDictionary<TValue> dictionary)
                {
