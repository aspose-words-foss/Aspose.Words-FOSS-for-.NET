...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class IntToIntDictionary
    {
        /// <summary>
        /// Initializes a new instance of the IntToIntDictionary&lt;int, int&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public IntToIntDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the IntToIntDictionary&lt;int, int&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public IntToIntDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the IntToIntDictionary&lt;int, int&gt; class that contains elements copied from the specified
        /// IntToIntDictionary&lt;int, int&gt;.
        /// </summary>
        public IntToIntDictionary(IntToIntDictionary dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the IntToIntDictionary&lt;int, int&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the IntToIntDictionary&lt;int, int&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the IntToIntDictionary&lt;int, int&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the IntToIntDictionary&lt;int, int&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the IntToIntDictionary&lt;int, int&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the IntToIntDictionary&lt;int, int&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(int key, int value, bool add)
        {
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the IntToIntDictionary&lt;int, int&gt;.
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the IntToIntDictionary&lt;int, int&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Returns corresponding key by a specified value.
        /// </summary>
        public int GetKey(int value)
        {
            ...
            while (enumerator.MoveNext())
            {
                if (enumerator.CurrentValue == value)
                    return enumerator.CurrentKey;
            }

            return GetNullSubstitute();
        }

        /// <summary>
        /// Represents an enumerator that iterates through the IntToIntDictionary&lt;int, int&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(IntToIntDictionary dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the IntToIntDictionary&lt;int, int&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the IntToIntDictionary&lt;int, int&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly IntToIntDictionary mDictionary;
