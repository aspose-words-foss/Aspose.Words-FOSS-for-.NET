...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class StringToObjDictionary<TValue>
        where TValue : class
    {
        /// <summary>
        /// Initializes a new instance of the StringToObjDictionary&lt;string, TValue&gt; class that is empty and has the default initial capacity.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToObjDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the StringToObjDictionary&lt;string, TValue&gt; class that is empty and has the specified initial capacity.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToObjDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the StringToObjDictionary&lt;string, TValue&gt; class that contains elements copied from the specified 
        /// StringToObjDictionary&lt;string, TValue&gt;.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToObjDictionary(StringToObjDictionary<TValue> dictionary)
        ...
        /// <summary>
        /// Initializes a new instance of the StringToObjDictionary&lt;string, TValue&gt; class that is empty, has the default initial capacity
        /// and uses either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToObjDictionary(bool isCaseSensitive)
            : this()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the StringToObjDictionary&lt;string, TValue&gt; class that is empty, has the specified initial capacity
        /// and uses either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToObjDictionary(int capacity, bool isCaseSensitive)
            : this(capacity)
        {
            mIgnoreCase = !isCaseSensitive;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the StringToObjDictionary&lt;string, TValue&gt; class that contains elements copied from the specified 
        /// StringToObjDictionary&lt;string, TValue&gt; using either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToObjDictionary(StringToObjDictionary<TValue> dictionary, bool isCaseSensitive)
        ...
        /// <summary>
        /// Adds the specified key and value to the StringToObjDictionary&lt;string, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the StringToObjDictionary&lt;string, TValue&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the StringToObjDictionary&lt;string, TValue&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the StringToObjDictionary&lt;string, TValue&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the StringToObjDictionary&lt;string, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the StringToObjDictionary&lt;string, TValue&gt;. Throws, if the specified key has already
        ...
        /// <summary>
        /// Removes the value with the specified key from the StringToObjDictionary&lt;string, TValue&gt;.
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the StringToObjDictionary&lt;string, TValue&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the keys in the StringToObjDictionary&lt;string, TValue&gt;. Do not use this when the key of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use StringToObjDictionary&lt;string, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Gets an enumeration of the values in the StringToObjDictionary&lt;string, TValue&gt;. Do not use this when the value of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use StringToObjDictionary&lt;string, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the StringToObjDictionary&lt;string, TValue&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(StringToObjDictionary<TValue> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the StringToObjDictionary&lt;string, TValue&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the StringToObjDictionary&lt;string, TValue&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly StringToObjDictionary<TValue> mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of keys in a StringToObjDictionary&lt;string, TValue&gt;.
        /// </summary>
        private class KeyEnumeration : IEnumerable<string>
        {
            ...
            /// Ctor.
            /// </summary>
            internal KeyEnumeration(StringToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the keys in a StringToObjDictionary&lt;string, TValue&gt;.
            /// </summary>
            private class KeyEnumerator : IEnumerator<string>
            {
                ...
                /// Ctor.
                /// </summary>
                internal KeyEnumerator(StringToObjDictionary<TValue> dictionary)
                {
        ...
        /// <summary>
        /// Represents the enumeration of values in a StringToObjDictionary&lt;string, TValue&gt;.
        /// </summary>
        private class ValueEnumeration : IEnumerable<TValue>
        {
            ...
            /// Ctor.
            /// </summary>
            internal ValueEnumeration(StringToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the values in a StringToObjDictionary&lt;string, TValue&gt;.
            /// </summary>
            private class ValueEnumerator : IEnumerator<TValue>
            {
                ...
                /// Ctor.
                /// </summary>
                internal ValueEnumerator(StringToObjDictionary<TValue> dictionary)
                {
                    mEnumerator = dictionary.GetEnumerator();
                }
