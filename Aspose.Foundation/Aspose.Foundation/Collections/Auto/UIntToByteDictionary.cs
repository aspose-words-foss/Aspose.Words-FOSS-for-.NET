...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class UIntToByteDictionary
    {
        /// <summary>
        /// Initializes a new instance of the UIntToByteDictionary&lt;uint, byte&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public UIntToByteDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the UIntToByteDictionary&lt;uint, byte&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public UIntToByteDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the UIntToByteDictionary&lt;uint, byte&gt; class that contains elements copied from the specified 
        /// UIntToByteDictionary&lt;uint, byte&gt;.
        /// </summary>
        public UIntToByteDictionary(UIntToByteDictionary dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the UIntToByteDictionary&lt;uint, byte&gt;.
        /// </summary>
        public void Add(uint key, byte value)
        {
            Insert(key, value, true);
        }

        /// <summary>
        /// Removes all keys and values from the UIntToByteDictionary&lt;uint, byte&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the UIntToByteDictionary&lt;uint, byte&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the UIntToByteDictionary&lt;uint, byte&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the UIntToByteDictionary&lt;uint, byte&gt;.
        /// </summary>
        ...
        private void Initialize(int capacity)
        {
            ...
            mValues = new byte[size];
            mFreeList = InvalidIndex;
        }

        /// <summary>
        /// Inserts the specified key and value to the UIntToByteDictionary&lt;uint, byte&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(uint key, byte value, bool add)
        {
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the UIntToByteDictionary&lt;uint, byte&gt;.
        ...
        /// </summary>
        private static int GetHashCode(uint key)
        {
        ...
        /// </summary>
        private static bool CompareKeys(uint key1, uint key2)
        {
            return key1 == key2;
        }
        ...
        /// </summary>
        private static bool CompareValues(byte value1, byte value2)
        {
        ...
        /// </summary>
        private static byte GetNullSubstitute()
        {
        ...
        /// </summary>
        public static bool IsNullSubstitute(byte value)
        {
            return CompareValues(value, gNullSubstitute);
        }

        /// <summary>
        /// Gets the number of key/value pairs contained in the UIntToByteDictionary&lt;uint, byte&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the UIntToByteDictionary&lt;uint, byte&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(UIntToByteDictionary dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the UIntToByteDictionary&lt;uint, byte&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the UIntToByteDictionary&lt;uint, byte&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly UIntToByteDictionary mDictionary;
        ...
        private readonly uint mDefaultKey;
        private readonly byte mDefaultValue;
        ...
        private static readonly byte gNullSubstitute = GetNullSubstitute();
