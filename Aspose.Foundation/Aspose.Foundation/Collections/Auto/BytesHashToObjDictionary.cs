...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class BytesHashToObjDictionary<TValue>
        where TValue : class
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the BytesHashToObjDictionary&lt;BytesHash, TValue&gt; class that contains elements copied from the specified 
        /// BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// </summary>
        public BytesHashToObjDictionary(BytesHashToObjDictionary<TValue> dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// </summary>
        public void Add(BytesHash key, TValue value)
        {
            Insert(key, value, true);
        }

        /// <summary>
        /// Removes all keys and values from the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0) 
        ...
        /// <summary>
        /// Determines whether the BytesHashToObjDictionary&lt;BytesHash, TValue&gt; contains the specified key.
        /// </summary>
        public bool ContainsKey(BytesHash key)
        {
            return (FindEntry(key) >= 0);
        }

        /// <summary>
        /// Determines whether the BytesHashToObjDictionary&lt;BytesHash, TValue&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// </summary>
        ...
        /// </summary>
        private int FindEntry(BytesHash key)
        {
            if (mBuckets != null)
            {
        ...
        /// <summary>
        /// Inserts the specified key and value to the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;. Throws, if the specified key has already
        ...
        private void Resize()
        {
            ...
            BytesHash[] newKeys = new BytesHash[newSize];
        ...
        /// <summary>
        /// Removes the value with the specified key from the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// Returns a value indicating whether the item was successfully found and removed.
        /// </summary>
        public bool Remove(BytesHash key)
        {
            if (mBuckets != null)
            {
                int hashCode = GetHashCode(key);
        ...
        /// </summary>
        private static int GetHashCode(BytesHash key)
        {
        ...
        /// </summary>
        private static bool CompareKeys(BytesHash key1, BytesHash key2)
        {
            return (key1 == key2);
        }
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the values in the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;. Do not use this when the value of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        public IEnumerable<TValue> Values
        {
            get
            {
                if (mValueEnumeration == null)
                    mValueEnumeration = new ValueEnumeration(this);

                return mValueEnumeration;
            }
        }
        ...
        /// </summary>
        public TValue this[BytesHash key]
        {
            get
            {
                int i = FindEntry(key);
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(BytesHashToObjDictionary<TValue> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly BytesHashToObjDictionary<TValue> mDictionary;
        ...
        /// <summary>
        /// Represents the enumeration of values in a BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
        /// </summary>
        private class ValueEnumeration : IEnumerable<TValue>
        {
            ...
            /// Ctor.
            /// </summary>
            internal ValueEnumeration(BytesHashToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the values in a BytesHashToObjDictionary&lt;BytesHash, TValue&gt;.
            /// </summary>
            private class ValueEnumerator : IEnumerator<TValue>
            {
                ...
                /// Ctor.
                /// </summary>
                internal ValueEnumerator(BytesHashToObjDictionary<TValue> dictionary)
                {
        ...
        private readonly BytesHash mDefaultKey;
