...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class StringToCharDictionary
    {
        /// <summary>
        /// Initializes a new instance of the StringToCharDictionary&lt;string, char&gt; class that is empty and has the default initial capacity.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToCharDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the StringToCharDictionary&lt;string, char&gt; class that is empty and has the specified initial capacity.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToCharDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the StringToCharDictionary&lt;string, char&gt; class that contains elements copied from the specified 
        /// StringToCharDictionary&lt;string, char&gt;.
        /// Uses case-sensitive ordinal key comparison.
        /// </summary>
        public StringToCharDictionary(StringToCharDictionary dictionary)
        ...
        /// <summary>
        /// Initializes a new instance of the StringToCharDictionary&lt;string, char&gt; class that is empty, has the default initial capacity
        /// and uses either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToCharDictionary(bool isCaseSensitive)
            : this()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the StringToCharDictionary&lt;string, char&gt; class that is empty, has the specified initial capacity
        /// and uses either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToCharDictionary(int capacity, bool isCaseSensitive)
            : this(capacity)
        {
            mIgnoreCase = !isCaseSensitive;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the StringToCharDictionary&lt;string, char&gt; class that contains elements copied from the specified 
        /// StringToCharDictionary&lt;string, char&gt; using either case-sensitive or case-insensitive ordinal key comparison.
        /// </summary>
        public StringToCharDictionary(StringToCharDictionary dictionary, bool isCaseSensitive)
        ...
        /// <summary>
        /// Adds the specified key and value to the StringToCharDictionary&lt;string, char&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the StringToCharDictionary&lt;string, char&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the StringToCharDictionary&lt;string, char&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the StringToCharDictionary&lt;string, char&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the StringToCharDictionary&lt;string, char&gt;.
        /// </summary>
        ...
        private void Initialize(int capacity)
        {
            ...
            mValues = new char[size];
            mFreeList = InvalidIndex;
        }

        /// <summary>
        /// Inserts the specified key and value to the StringToCharDictionary&lt;string, char&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(string key, char value, bool add)
        {
            CheckKeyNotNull(key);
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the StringToCharDictionary&lt;string, char&gt;.
        ...
        /// </summary>
        private static bool CompareValues(char value1, char value2)
        {
        ...
        /// </summary>
        private static char GetNullSubstitute()
        {
        ...
        /// </summary>
        public static bool IsNullSubstitute(char value)
        {
            return CompareValues(value, gNullSubstitute);
        }

        /// <summary>
        /// Gets the number of key/value pairs contained in the StringToCharDictionary&lt;string, char&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the keys in the StringToCharDictionary&lt;string, char&gt;. Do not use this when the key of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use StringToCharDictionary&lt;string, char&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the StringToCharDictionary&lt;string, char&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(StringToCharDictionary dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the StringToCharDictionary&lt;string, char&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the StringToCharDictionary&lt;string, char&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly StringToCharDictionary mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of keys in a StringToCharDictionary&lt;string, char&gt;.
        /// </summary>
        private class KeyEnumeration : IEnumerable<string>
        {
            ...
            /// Ctor.
            /// </summary>
            internal KeyEnumeration(StringToCharDictionary dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the keys in a StringToCharDictionary&lt;string, char&gt;.
            /// </summary>
            private class KeyEnumerator : IEnumerator<string>
            {
                ...
                /// Ctor.
                /// </summary>
                internal KeyEnumerator(StringToCharDictionary dictionary)
                {
        ...
        private readonly char mDefaultValue;
        ...
        private static readonly char gNullSubstitute = GetNullSubstitute();
