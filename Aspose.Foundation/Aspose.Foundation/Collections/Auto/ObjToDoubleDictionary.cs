...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class ObjToDoubleDictionary<TKey>
        where TKey : class
    {
        /// <summary>
        /// Initializes a new instance of the ObjToDoubleDictionary&lt;TKey, double&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public ObjToDoubleDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the ObjToDoubleDictionary&lt;TKey, double&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public ObjToDoubleDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the ObjToDoubleDictionary&lt;TKey, double&gt; class that contains elements copied from the specified 
        /// ObjToDoubleDictionary&lt;TKey, double&gt;.
        /// </summary>
        public ObjToDoubleDictionary(ObjToDoubleDictionary<TKey> dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the ObjToDoubleDictionary&lt;TKey, double&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the ObjToDoubleDictionary&lt;TKey, double&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the ObjToDoubleDictionary&lt;TKey, double&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the ObjToDoubleDictionary&lt;TKey, double&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the ObjToDoubleDictionary&lt;TKey, double&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the ObjToDoubleDictionary&lt;TKey, double&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(TKey key, double value, bool add)
        {
            CheckKeyNotNull(key);
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the ObjToDoubleDictionary&lt;TKey, double&gt;.
        ...
        /// </summary>
        private static bool CompareValues(double value1, double value2)
        {
        ...
        /// </summary>
        private static double GetNullSubstitute()
        {
        ...
        /// </summary>
        public static bool IsNullSubstitute(double value)
        {
            return CompareValues(value, gNullSubstitute);
        }

        /// <summary>
        /// Gets the number of key/value pairs contained in the ObjToDoubleDictionary&lt;TKey, double&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the keys in the ObjToDoubleDictionary&lt;TKey, double&gt;. Do not use this when the key of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use ObjToDoubleDictionary&lt;TKey, double&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the ObjToDoubleDictionary&lt;TKey, double&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(ObjToDoubleDictionary<TKey> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the ObjToDoubleDictionary&lt;TKey, double&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the ObjToDoubleDictionary&lt;TKey, double&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly ObjToDoubleDictionary<TKey> mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of keys in a ObjToDoubleDictionary&lt;TKey, double&gt;.
        /// </summary>
        private class KeyEnumeration : IEnumerable<TKey>
        {
            ...
            /// Ctor.
            /// </summary>
            internal KeyEnumeration(ObjToDoubleDictionary<TKey> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the keys in a ObjToDoubleDictionary&lt;TKey, double&gt;.
            /// </summary>
            private class KeyEnumerator : IEnumerator<TKey>
            {
                ...
                /// Ctor.
                /// </summary>
                internal KeyEnumerator(ObjToDoubleDictionary<TKey> dictionary)
                {
        ...
        private readonly double mDefaultValue;
        ...
        private static readonly double gNullSubstitute = GetNullSubstitute();
