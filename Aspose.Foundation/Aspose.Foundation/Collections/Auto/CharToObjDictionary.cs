...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class CharToObjDictionary<TValue>
        where TValue : class
    {
        /// <summary>
        /// Initializes a new instance of the CharToObjDictionary&lt;char, TValue&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public CharToObjDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the CharToObjDictionary&lt;char, TValue&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public CharToObjDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the CharToObjDictionary&lt;char, TValue&gt; class that contains elements copied from the specified 
        /// CharToObjDictionary&lt;char, TValue&gt;.
        /// </summary>
        public CharToObjDictionary(CharToObjDictionary<TValue> dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the CharToObjDictionary&lt;char, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Removes all keys and values from the CharToObjDictionary&lt;char, TValue&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the CharToObjDictionary&lt;char, TValue&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the CharToObjDictionary&lt;char, TValue&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the CharToObjDictionary&lt;char, TValue&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the CharToObjDictionary&lt;char, TValue&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(char key, TValue value, bool add)
        {
            if (mBuckets == null)
                Initialize(0);
        ...
        /// <summary>
        /// Removes the value with the specified key from the CharToObjDictionary&lt;char, TValue&gt;.
        ...
        /// </summary>
        private static int GetHashCode(char key)
        {
        ...
        /// </summary>
        private static bool CompareKeys(char key1, char key2)
        {
            return key1 == key2;
        }
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the CharToObjDictionary&lt;char, TValue&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Gets an enumeration of the values in the CharToObjDictionary&lt;char, TValue&gt;. Do not use this when the value of the dictionary
        /// is of nullable struct type as it will introduce extra boxings, use CharToObjDictionary&lt;char, TValue&gt;.GetEnumerator() instead.
        /// </summary>
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the CharToObjDictionary&lt;char, TValue&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(CharToObjDictionary<TValue> dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the CharToObjDictionary&lt;char, TValue&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the CharToObjDictionary&lt;char, TValue&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly CharToObjDictionary<TValue> mDictionary;
            private readonly int mVersion;
            private int mIndex;
        }

        /// <summary>
        /// Represents the enumeration of values in a CharToObjDictionary&lt;char, TValue&gt;.
        /// </summary>
        private class ValueEnumeration : IEnumerable<TValue>
        {
            ...
            /// Ctor.
            /// </summary>
            internal ValueEnumeration(CharToObjDictionary<TValue> dictionary)
            {
                mDictionary = dictionary;
            }
            ...
            /// <summary>
            /// Enumerates the values in a CharToObjDictionary&lt;char, TValue&gt;.
            /// </summary>
            private class ValueEnumerator : IEnumerator<TValue>
            {
                ...
                /// Ctor.
                /// </summary>
                internal ValueEnumerator(CharToObjDictionary<TValue> dictionary)
                {
        ...
        private readonly char mDefaultKey;
