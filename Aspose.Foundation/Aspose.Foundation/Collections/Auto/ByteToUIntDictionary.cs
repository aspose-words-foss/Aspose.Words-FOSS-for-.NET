...
namespace Aspose.Collections
{
    ...
    /// </dev>
    public class ByteToUIntDictionary
    {
        /// <summary>
        /// Initializes a new instance of the ByteToUIntDictionary&lt;byte, uint&gt; class that is empty and has the default initial capacity.
        /// </summary>
        public ByteToUIntDictionary()
            : this(0)
        {
        }

        /// <summary>
        /// Initializes a new instance of the ByteToUIntDictionary&lt;byte, uint&gt; class that is empty and has the specified initial capacity.
        /// </summary>
        public ByteToUIntDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the ByteToUIntDictionary&lt;byte, uint&gt; class that contains elements copied from the specified 
        /// ByteToUIntDictionary&lt;byte, uint&gt;.
        /// </summary>
        public ByteToUIntDictionary(ByteToUIntDictionary dictionary)
        ...
        /// <summary>
        /// Adds the specified key and value to the ByteToUIntDictionary&lt;byte, uint&gt;.
        /// </summary>
        public void Add(byte key, uint value)
        {
            Insert(key, value, true);
        }

        /// <summary>
        /// Removes all keys and values from the ByteToUIntDictionary&lt;byte, uint&gt;.
        /// </summary>
        public void Clear()
        {
            if (mCount == 0)
        ...
        /// <summary>
        /// Determines whether the ByteToUIntDictionary&lt;byte, uint&gt; contains the specified key.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the ByteToUIntDictionary&lt;byte, uint&gt; contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the ByteToUIntDictionary&lt;byte, uint&gt;.
        /// </summary>
        ...
        /// </summary>
        private int FindEntry(byte key)
        {
            if (mBuckets != null)
            {
        ...
        private void Initialize(int capacity)
        {
            ...
            mValues = new uint[size];
            mFreeList = InvalidIndex;
        }

        /// <summary>
        /// Inserts the specified key and value to the ByteToUIntDictionary&lt;byte, uint&gt;. Throws, if the specified key has already
        /// been added to the dictionary and <paramref name="add"/> is set to true.
        /// </summary>
        private void Insert(byte key, uint value, bool add)
        {
            if (mBuckets == null)
                Initialize(0);
        ...
        private void Resize()
        {
            ...
            uint[] newValues = new uint[newSize];
        ...
        /// <summary>
        /// Removes the value with the specified key from the ByteToUIntDictionary&lt;byte, uint&gt;.
        ...
        /// </summary>
        private static bool CompareValues(uint value1, uint value2)
        {
        ...
        /// </summary>
        private static uint GetNullSubstitute()
        {
        ...
        /// </summary>
        public static bool IsNullSubstitute(uint value)
        {
            return CompareValues(value, gNullSubstitute);
        }

        /// <summary>
        /// Gets the number of key/value pairs contained in the ByteToUIntDictionary&lt;byte, uint&gt;.
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        /// Represents an enumerator that iterates through the ByteToUIntDictionary&lt;byte, uint&gt;. In contrast to built-in .Net class,
        ...
        public class Enumerator
        {
            ...
            /// Ctor.
            /// </summary>
            internal Enumerator(ByteToUIntDictionary dictionary)
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the ByteToUIntDictionary&lt;byte, uint&gt;.
            /// </summary>
            ...
            /// <summary>
            /// Sets the enumerator to its initial position, which is before the first element in the ByteToUIntDictionary&lt;byte, uint&gt;.
            /// </summary>
            public void Reset()
            {
                EnsureVersion();
            ...
            private readonly ByteToUIntDictionary mDictionary;
        ...
        private readonly byte mDefaultKey;
        private readonly uint mDefaultValue;
        ...
        private static readonly uint gNullSubstitute = GetNullSubstitute();
