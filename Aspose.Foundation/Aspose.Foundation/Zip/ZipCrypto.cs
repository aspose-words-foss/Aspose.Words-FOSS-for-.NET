...
namespace Aspose.Zip
{
    ...
    internal class ZipCrypto
    {
        ...
        {
            if (cipherText == null)
                throw new ZipException("Cannot decrypt.",
                                       new ArgumentException(
                                           "Bad length during Decryption: cipherText must be non-null.", "cipherText"));
        ...
        {
            if (plaintext == null)
                throw new ZipException("Cannot encrypt.",
                                       new ArgumentException(
                                           "Bad length during Encryption: the plainText must be non-null.", "plaintext"));
