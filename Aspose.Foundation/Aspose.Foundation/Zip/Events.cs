...
namespace Aspose.Zip
{
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="ZipFile.WantCompression"/>
    [JavaDelete("For ZIP on Java we use a completely different implementation.")]
    ...
    public class ExtractProgressEventArgs : ZipProgressEventArgs
    {
        ...
        {
            ExtractProgressEventArgs x = new ExtractProgressEventArgs(archiveName, ZipProgressEventType.Extracting_BeforeExtractEntry);
            x.CurrentEntry = entry;
        ...
        {
            ExtractProgressEventArgs x = new ExtractProgressEventArgs(archiveName, ZipProgressEventType.Extracting_ExtractEntryWouldOverwrite);
            x.CurrentEntry = entry;
            x._target = extractLocation;
            return x;
        }
        ...
        {
            ExtractProgressEventArgs x = new ExtractProgressEventArgs(archiveName, ZipProgressEventType.Extracting_AfterExtractEntry);
            x.CurrentEntry = entry;
            x._target = extractLocation;
            return x;
        }
    ...
    public class ZipErrorEventArgs : ZipProgressEventArgs
    {
        ...
        internal static ZipErrorEventArgs Saving(string archiveName, ZipEntry entry, Exception exception)
        {
            ...
            x.EventType = ZipProgressEventType.Error_Saving;
            x.ArchiveName = archiveName;
            x.CurrentEntry = entry;
            x._exc = exception;
            return x;
