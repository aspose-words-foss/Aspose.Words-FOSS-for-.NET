...
//
// last saved (in emacs):
// Time-stamp: <2009-September-18 15:57:16>
//
// ------------------------------------------------------------------
//
...
#pragma warning disable IDE0049, IDE1006, RCS1037
...
namespace Aspose.Zip
{
    ...
    public class ZipEntry
    {
        ...
        {
            get { return _zipfile.BufferSize; }
        }
        ...
        /// <seealso cref="ZipEntry.LastModified"/>
        ...
        ///
        /// <seealso cref="Aspose.Zip.ZipFile.ForceNoCompression"/>
        ...
        public string FileName
        {
            ...
            set
            {
                ...
                if (_zipfile.EntryFileNames.Contains(filename))
                {
                    throw new ZipException(
                        String.Format("Cannot rename {0} to {1}; an entry by that name already exists in the archive.",
            ...
            set
            {
                ...
                if (_Source == ZipEntrySource.ZipFile && _sourceIsEncrypted)
                    throw new InvalidOperationException(
                        "Cannot change compression method on encrypted entries read from archives.");
        ...
        /// <c>ZipFile</c> that contains the ZipEntry.
        /// </remarks>
        /// <seealso cref="ZipEntry.CompressedSize"/>
        ...
        /// </example>
        ///
        /// <seealso cref="ZipEntry.Encryption"/>
...
#pragma warning restore CA1044 // Properties should not be write only
        ...
        ///     extraction would overwrite an existing filesystem file. If you do
        ...
        ///
        /// </remarks>
        /// <seealso cref="Aspose.Zip.ZipFile.ZipErrorAction"/>
        ...
        /// <seealso cref="Aspose.Zip.ReReadApprovalCallback"/>
        ...
        {
            get { return _provisionalAlternateEncoding == Encoding.GetEncoding("UTF-8"); }
            set { _provisionalAlternateEncoding = (value) ? Encoding.GetEncoding("UTF-8") : ZipFile.DefaultEncoding; }
        }
        ...
        internal static string NameInArchive(String filename, string directoryPathInArchive)
        {
            ...
            {
                if (directoryPathInArchive.Length == 0)
                {
        ...
        internal static ZipEntry Create(String filename, string nameInArchive, bool isStream, Stream stream)
        {
            ...
            if (isStream)
            {
                ...
                DateTime now = DateTimeUtil.GetNow().ToUniversalTime();
                entry._Mtime = now;
                entry._Atime = now;
                entry._Ctime = now;
            }
            ...
            // WORDSNET-4912
            // kvk: We should try to avoid unnecessary calls to file system because they could
            // throw SecurityException under Medium Trust.
            entry._LocalFileName = isStream ? filename : Path.GetFullPath(filename);
        ...
        private const bool _TrimVolumeFromFullyQualifiedPaths = true; // by default, trim them.
        ...
        private NullableInt64 _sourceStreamOriginalPosition;
        private bool _sourceWasJitProvided;
        private bool _ioOperationCanceled;
        private bool _presumeZip64;
        private NullableBool _entryRequiresZip64;
...
//#endif
        ...
        internal static ZipEntry ReadDirEntry(ZipFile zf)
        {
            ...
            Encoding expectedEncoding = zf.ProvisionalAlternateEncoding;
            ...
            if (IsNotValidZipDirEntrySig(signature))
            {
                    ...
                    )
                {
                    throw new BadReadException(
                        string.Format("  ZipEntry::ReadDirEntry(): Bad signature (0x{0:X8}) at position 0x{1:X8}",
            ...
            // workitem 6898
            if (zde._LocalFileName.EndsWith("/", StringComparison.Ordinal))
                zde.MarkAsDirectory();
            ...
            if (zde._extraFieldLength > 0)
            {
                ...
                zde.ProcessExtraField(zde._extraFieldLength);
                zde._CompressedFileDataSize = zde._CompressedSize;
            }
        ...
        /// <seealso cref="Aspose.Zip.ZipFile.Extract()"/>
        ///
        /// <example>
        ...
        /// cref="ZipEntry.ExtractExistingFile"/>property, or call <see
        ...
        ///
        /// <param name="password">The Password to use for decrypting the entry.</param>
        public void ExtractWithPassword(string baseDirectory, ExtractExistingFileAction extractExistingFile,
                                        string password)
        {
            ExtractExistingFile = extractExistingFile;
            InternalExtract(baseDirectory, null, password);
        ...
        ///
        /// <para>
        /// The return value is a <see cref="CrcCalculatorStream"/>.  Use it
        ...
        /// <see cref="CrcCalculatorStream.Crc"/> property on the
        ...
        public CrcCalculatorStream OpenReader()
        {
            ...
            return InternalOpenReader(_Password != null ? _Password : _zipfile._Password);
        }
        ...
        private void InternalExtract(string baseDir, Stream outstream, string password)
        {
            ...
            try
            {
                ...
                // When our stream is a FileStream, this means we need to extract entry to a file.
                FileStream fs = outstream as FileStream;
                bool extractToFile = (fs != null) && (!IsDirectory);

                if (extractToFile)
                {
                    TargetFile = fs.Name;
                }
                else if (ValidateOutput(baseDir, outstream, out TargetFile))
                {
                    if (_zipfile.Verbose)
                        _zipfile.StatusMessageTextWriter.WriteLine("extract dir {0}...", TargetFile);
                ...
                string p = password != null ? password : (_Password != null ? _Password : _zipfile._Password);
                if (UsesEncryption)
                {
                    if (p == null)
                ...
                {
                    if (_zipfile.Verbose)
                        _zipfile.StatusMessageTextWriter.WriteLine("extract file {0}...", TargetFile);
                    ...
                    if (extractToFile)
                    {
                        // FileStream is aleady created and opened, just use it.
                        output = fs;
                    }
                    else
                    {
                        ...
                        if (File.Exists(TargetFile))
                        {
                            ...
                            rc = CheckExtractExistingFile(baseDir, TargetFile);
                        }
                ...
                if ((TargetFile != null) && (!extractToFile))
                {
                    output.Close();
                    output = null;
                    ...
                    if (checkLaterForResetDirTimes && (FileName.IndexOf('/') != -1))
                    {
                        string dirname = Path.GetDirectoryName(FileName);
                        if (_zipfile[dirname] == null)
                        {
            ...
            {
                if (_ioOperationCanceled && (TargetFile != null))
                {
                    if (output != null)
                        output.Close();
                    ...
                    if (File.Exists(TargetFile) &&
                        (!fileExistsBeforeExtraction || (ExtractExistingFile == ExtractExistingFileAction.OverwriteSilently)))
            ...
            while (true)
            {
                switch (ExtractExistingFile)
                {
                    ...
                    case ExtractExistingFileAction.DoNotOverwrite:
                        if (_zipfile.Verbose)
                            _zipfile.StatusMessageTextWriter.WriteLine("the file {0} exists; not extracting entry...",
                                                                       FileName);
                        OnAfterExtract(baseDir);
                        return 1;
        ...
        /// <summary>
        /// Returns a copy of entry compressed data.
        /// </summary>
        internal byte[] GetCompressedBytes()
        {
            Stream input = ArchiveStream;
            ...
            byte[] compressedData = new byte[_CompressedFileDataSize];
            // WORDSNET-25139 The check for complete reading of data from the stream.
            int bufferSize = compressedData.Length;
            int bufferOffset = 0;
            while (bufferSize > bufferOffset)
            {
                int bytesRead = input2.Read(compressedData, bufferOffset, bufferSize - bufferOffset);

                // Check that the data has been read - necessary to detect corrupted zip files.
        ...
        private Int32 _ExtractOne(Stream output)
        {
            ...
            Int64 LeftToRead = (CompressionMethod == 0x08) ? UncompressedSize : _CompressedFileDataSize;
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            {
                // workitem 6191
                DateTime AdjustedLastModified = SharedUtilities.AdjustTime_DotNetToWin32(LastModified);
        ...
        private bool ValidateOutput(string basedir, Stream outstream, out string OutputFile)
        {
            if (basedir != null)
            {
                ...
                if (f.StartsWith("/", StringComparison.Ordinal))
                    f = FileName.Substring(1);

                OutputFile = GetOutputFile(basedir, f);
        ...
        /// </summary>
        private string GetOutputFile(string basedir, string f)
        {
            if (_zipfile.FlattenFoldersOnExtract)
                return Path.Combine(basedir, (f.IndexOf('/') != -1) ? Path.GetFileName(f) : f);

            return Path.Combine(basedir, f);
        }
        ...
        private static bool ReadHeader(ZipEntry ze, Encoding defaultEncoding)
        {
            ...
            if (IsNotValidSig(signature))
            {
                ...
                {
                    throw new BadReadException(
                        String.Format("  ZipEntry::ReadHeader(): Bad signature (0x{0:X8}) at position  0x{1:X8}",
            ...
            // NB: if ze._BitField & 0x0008 is not set, then the Compressed, uncompressed and
            ...
            // workitem 6898
            if (ze._LocalFileName.EndsWith("/", StringComparison.Ordinal))
                ze.MarkAsDirectory();
            ...
            if (!ze._LocalFileName.EndsWith("/", StringComparison.Ordinal) && (ze._BitField & 0x0008) == 0x0008)
            {
                ...
                while (wantMore)
                {
                    ...
                    long d =
                        SharedUtilities.FindSignature(ze.ArchiveStream, ZipConstants.ZipEntryDataDescriptorSignature);
                    if (d == -1)
                        return false;
        ...
        internal static ZipEntry Read(ZipFile zf, bool first)
        {
            ...
            Encoding defaultEncoding = zf.ProvisionalAlternateEncoding;
            ZipEntry entry = new ZipEntry();
            ...
            if (extraFieldLength > 0)
            {
                ...
                while (j < Buffer.Length)
                {
                    ...
                    switch (HeaderId)
                    {
                        ...
                        default:
                            // RK There should be a default case and it should be handled in a reasonable manner.
                            // But this is 3rd party code that we do not change (it works okay) so I am just adding
                            // this case to satisfy SQ.
                            break;
                    }
        ...
        private int ProcessExtraFieldZip64(byte[] Buffer, int j, Int16 DataSize, long posn)
        {
            ...
            // WORDSNET-26118 Note that this code used to check that the ZIP64 block size is not greater than 28 bytes. But
            // we've seen a EPUB document with a 32-byte long ZIP64 block, which many tools (Calibre, Adobe Digital Editions,
            // WinRar) are able to load successfully. We've decided that Aspose.Words should support such documents too, so
            // we've removed the check completely.
            ...
            if (_UncompressedSize == 0xFFFFFFFF)
            {
                if (remainingData < 8)
                    throw new BadReadException(
                        String.Format("  Missing data for ZIP64 extra field (Uncompressed Size) at position 0x{0:X16}",
                                      posn));
            ...
            if (_CompressedSize == 0xFFFFFFFF)
            {
                if (remainingData < 8)
                    throw new BadReadException(
                        String.Format("  Missing data for ZIP64 extra field (Compressed Size) at position 0x{0:X16}",
                                      posn));
            ...
            if (_RelativeOffsetOfLocalHeader == 0xFFFFFFFF)
            {
                if (remainingData < 8)
                    throw new BadReadException(
                        String.Format("  Missing data for ZIP64 extra field (Relative Offset) at position 0x{0:X16}",
                                      posn));
        ...
        private int ProcessExtraFieldInfoZipTimes(byte[] Buffer, int j, Int16 DataSize, long posn)
        {
            if (DataSize != 12 && DataSize != 8)
                throw new BadReadException(
                    String.Format("  Unexpected datasize (0x{0:X4}) for InfoZip v1 extra field at position 0x{1:X16}",
                                  DataSize, posn));
        ...
        private int ProcessExtraFieldUnixTimes(byte[] Buffer, int j, Int16 DataSize, long posn)
        {
            ...
            // storing seconds since Unix epoch.
            {
                if (DataSize != 13 && DataSize != 9 && DataSize != 5)
                    throw new BadReadException(
                        String.Format(
                            "  Unexpected datasize (0x{0:X4}) for Extended Timestamp extra field at position 0x{1:X16}",
                            DataSize, posn));
                ...
                if (DataSize == 13 || _readExtraDepth > 1)
                {
                    ...
                    {
                        Int32 timet = BitConverter.ToInt32(Buffer, j);
                        _Ctime = _unixEpoch.AddSeconds(timet);
                        j += 4;
                    }
                    else
                        _Ctime = DateTime.UtcNow;
        ...
        private int ProcessExtraFieldWindowsTimes(byte[] Buffer, int j, Int16 DataSize, long posn)
        {
            ...
            // ctime      8 bytes    win32 ticks since win32epoch
            {
                if (DataSize != 32)
                    throw new BadReadException(
                        String.Format(
                            "  Unexpected datasize (0x{0:X4}) for NTFS times extra field at position 0x{1:X16}",
                            DataSize, posn));
        ...
        private void _ConsAndWriteCentralDirectoryEntry(Stream s)
        {
            ...
            // WORDSNET-20169 Set flags to BitField that determine which compression option was used.
            if (IsDeflated)
        ...
        {
            IList<byte[]> listOfBlocks = new List<byte[]>();
            byte[] block;
            ...
            if (listOfBlocks.Count > 0)
            {
                ...
                for (i = 0; i < listOfBlocks.Count; i++)
                    totalLength += ((byte[])listOfBlocks[i]).Length;
                aggregateBlock = new byte[totalLength];
                for (i = 0; i < listOfBlocks.Count; i++)
                {
                    Array.Copy((byte[])listOfBlocks[i], 0, aggregateBlock, current, ((byte[])listOfBlocks[i]).Length);
                    current += ((byte[])listOfBlocks[i]).Length;
                }
            }
        ...
        private byte[] _GetEncodedFileNameBytes()
        {
            ...
            if (s2 == s1)
            {
                ...
                Encoding commentEncoding = GenerateCommentBytes();
        ...
        private bool WantReadAgain()
        {
            if (_UncompressedSize < 0x10)
                return false;
            if (_CompressionMethod == 0x00)
                return false;
            if (_zipfile.CompressionLevel == CompressionLevel.None)
                return false;
        ...
        private void FigureCompressionMethodForWriting(int cycle)
        {
            ...
            else
            {
                ...
                if (_ForceNoCompression || (_zipfile.CompressionLevel == CompressionLevel.None))
                {
                    _CompressionMethod = 0x00;
                    return;
                }
        ...
        private void WriteHeader(Stream s, int cycle)
        {
            ...
            if (ActualEncoding.CodePage == Encoding.UTF8.CodePage)
                _BitField = (short)((ushort)_BitField | 0x0800);
            ...
            if (!s.CanSeek)
                _BitField = (short)((ushort)_BitField | 0x0008);
        ...
        /// </summary>
        private short CompressionFlags
        {
            get
            {
                switch (_zipfile.CompressionLevel)
                {
                    case CompressionLevel.Level1:
                        return 0x06;
                    case CompressionLevel.Level2:
                    case CompressionLevel.Level3:
                        return 0x04;
                    case CompressionLevel.Level4:
                    case CompressionLevel.Level5:
                    case CompressionLevel.Level6:
                    case CompressionLevel.Level7:
                    case CompressionLevel.Level8:
                        return 0x00;
                    case CompressionLevel.Level9:
                        return 0x02;
                    case CompressionLevel.Level0:
                    default:
        ...
        private bool IsDeflated { get { return (CompressionMethod == 0x08); } }
        ...
        private void PrepSourceStream()
        {
            ...
            else if (_sourceStream.CanSeek)
            {
                ...
                _sourceStreamOriginalPosition = new NullableInt64(_sourceStream.Position);
            }
        ...
        private void _WriteFileData(Stream s)
        {
            ...
            try
            {
                ...
                if (CompressionMethod == 0x08 && _zipfile.CompressionLevel != CompressionLevel.None)
                {
                    DeflateStream o = new DeflateStream(output1, CompressionMode.Compress,
                ...
                int n = SharedUtilities.ReadWithRetry(input1, buffer, 0, buffer.Length, FileName);
                while (n != 0)
                {
                    ...
                    n = SharedUtilities.ReadWithRetry(input1, buffer, 0, buffer.Length, FileName);
                }
            ...
            {
                if (_Source != ZipEntrySource.Stream && input != null)
                {
                    input.Close();
                }
            }
            ...
            // validate the ZIP64 usage
            if (_zipfile._zip64 == Zip64Option.Never && _entryRequiresZip64 == NullableBool.True)
                throw new ZipException(
                    "Compressed or Uncompressed size, or offset exceeds the maximum value. Consider setting the Zip64Mode save option.");

            _OutputUsesZip64 = (_zipfile._zip64 == Zip64Option.Always || _entryRequiresZip64 == NullableBool.True)
                                   ? NullableBool.True
                                   : NullableBool.False;
            ...
            {
                byte[] Descriptor = new byte[16 + (_OutputUsesZip64 == NullableBool.True ? 8 : 0)];
                i = 0;
                ...
                try
                {
                    if (IsDirectory)
                    {
                        ...
                        _entryRequiresZip64 = (_RelativeOffsetOfLocalHeader >= 0xFFFFFFFF)
                                                  ? NullableBool.True
                                                  : NullableBool.False;
                        _OutputUsesZip64 = (_zipfile._zip64 == Zip64Option.Always ||
                                            _entryRequiresZip64 == NullableBool.True)
                                               ? NullableBool.True
                                               : NullableBool.False;
                        return;
                    }
                            ...
                            ZipErrorAction == ZipErrorAction.Retry)
                        {
                            ...
                            if (ZipErrorAction == ZipErrorAction.Skip)
                            {
                                if (_zipfile.StatusMessageTextWriter != null)
                                    _zipfile.StatusMessageTextWriter.WriteLine("Skipping file {0} (exception: {1})",
                                                                               LocalFileName, exc1.ToString());
        ...
        private void _WriteSecurityMetadata(Stream outstream)
        {
            ...
            if (Encryption == EncryptionAlgorithm.PkzipWeak)
            {
                ...
                byte[] encryptionHeader = RandomUtil.GetRandomBytesArray(12);
        ...
        private void CopyThroughOneEntry(Stream outstream)
        {
            ...
            CrcCalculatorStream input1 = new CrcCalculatorStream(ArchiveStream);
        ...
        private void CopyThroughWithRecompute(Stream outstream, CrcCalculatorStream input1)
        {
            ...
            if (!FileName.EndsWith("/", StringComparison.Ordinal))
            {
                ...
                if ((_BitField & 0x0008) == 0x0008)
                {
                    ...
                    StreamUtil.Read(input, Descriptor, 0, size);
...
#pragma warning restore IDE0049, IDE1006, RCS1037
