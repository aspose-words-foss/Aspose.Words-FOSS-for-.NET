...
//
// last saved (in emacs): 
// Time-stamp: <2009-September-18 21:19:16>
//
// ------------------------------------------------------------------
//
...
namespace Aspose.Zip
{
    ...
    public class GZipStream : Stream
    {
        ...
        /// 
        /// <para>
        /// The <see cref="CompressionMode"/> (Compress or Decompress) also establishes
        ...
        /// specify the compression level, see <see cref="GZipStream(Stream,
        ...
        internal static DateTime _unixEpoch = new DateTime(1970, 1, 1, 0, 0, 0, CultureInfo.InvariantCulture.Calendar);
        ...
        private int EmitHeader()
        {
            ...
            if (Comment != null)
            {
                commentBytes = iso8859dash1.GetBytes(Comment);
                cbLength = commentBytes.Length + 1;
            }

            if (FileName != null)
            {
                filenameBytes = iso8859dash1.GetBytes(FileName);
                fnLength = filenameBytes.Length + 1;
            }
            ...
            // mtime
            if (mLastModified == DateTime.MinValue)
                mLastModified = DateTime.Now;
            TimeSpan delta = mLastModified - _unixEpoch;
