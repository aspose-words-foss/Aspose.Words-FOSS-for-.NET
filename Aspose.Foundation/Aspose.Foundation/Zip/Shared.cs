...
//
// last saved (in emacs): 
// Time-stamp: <2009-September-19 15:51:57>
//
// ------------------------------------------------------------------
//
...
namespace Aspose.Zip
{
    ...
    internal class SharedUtilities
    {
        ...
        // WORDSNET-14349 Use random number generator with more entropy instead of System.Random to pass Veracode
        // security test.
        private static readonly IRandomGenerator _rnd = CryptoUtilPal.CreateRandomGenerator(DigestAlgorithm.Sha256);
        ...
        private static char GetOneRandomChar(int delta)
        {
            ...
            return (char)(GetRandomInt(26) + delta);
        }
    ...
    internal class CountingStream : System.IO.Stream
    {
        ...
        public void Adjust(Int64 delta)
        {
            ...
            CountingStream countingStream = _s as CountingStream;
            if (countingStream != null)
                countingStream.Adjust(delta);
        }
