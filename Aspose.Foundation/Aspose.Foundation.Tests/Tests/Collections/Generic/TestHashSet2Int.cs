...
namespace Aspose.Tests.Collections.Generic
{
    ...
    /// </remarks>
    [TestFixture]
    public class TestHashSet2Int
    {
        [Test]
        public void TestDefaultCtor()
        {
            Aspose.Collections.Generic.HashSetGeneric<int> hashSet = new Aspose.Collections.Generic.HashSetGeneric<int>();
        ...
        public void TestIEnumerableCtor()
        {
            ...
            list.Add(2);
            list.Add(3);
            Aspose.Collections.Generic.HashSetGeneric<int> hashSet = new Aspose.Collections.Generic.HashSetGeneric<int>(list);
