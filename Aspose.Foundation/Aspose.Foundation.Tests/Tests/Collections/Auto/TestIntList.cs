...
{
    /// <summary>
    /// Tests IntList class' functionality.
    /// </summary>
    /// <remarks>
    /// Every individual test of this class corresponds to a IntList member.
    /// See the corresponding IntList members' descriptions for any additional information.
    /// </remarks>
    [TestFixture]
    public class TestIntList
    {
        ...
        {
            int[] sortedArray = new int[gArray.Length];
            Array.Copy(gArray, sortedArray, gArray.Length);
            Array.Sort(sortedArray);

            IntList list = new IntList(gArray);
            list.Sort();
        ...
        public void TestSortBinarySearchPart()
        {
            ...
            int lastItem = gArray[gArray.Length - 1];
        ...
        {
            int[] expectedArray = new int[gArray.Length * 2 + 1];
            ...
            int[] actualArray = new int[gArray.Length * 2 + 1];
            IntList list = new IntList(gArray);
        ...
        {
            IntList list1 = new IntList(gArray);
            IntList list2 = list1.GetRange(1, list1.Count - 1);
            Assert.That(list2.Count, Is.EqualTo(list1.Count - 1));

            int[] expectedArray = new int[gArray.Length - 1];
        ...
        {
            int[] expectedArray = new int[gArray.Length + 3];
        ...
        {
            int[] expectedArray = new int[gArray.Length * 4];
            Array.Copy(gArray, expectedArray, gArray.Length);
            ...
            IntList list1 = new IntList(gArray);
            IntList list2 = new IntList(gArray);
        ...
        {
            int[] expectedArray = new int[gArray.Length * 2];
        ...
        {
            IntList list = new IntList(gArray);
            list.InsertRange(1, (IntList)null);
        }
        ...
        public void TestLastIndexOf()
        {
            ...
            int lastItem = list[lastItemIndex];
        ...
        {
            int[] expectedArray = new int[gArray.Length];
            Array.Copy(gArray, expectedArray, gArray.Length);
        ...
        {
            IntList list = new IntList((int[])null);
        ...
        {
            IntList list = new IntList((IntList)null);
            Assert.Fail(string.Format(string.Empty, list)); // Force the compiler not to skip the previous instruction.
        }
        ...
        /// <summary>
        /// Returns an instance of int type missing in an array returned by <see cref="GetArray"/>.
        /// </summary>
        private static int GetMissingItem()
        {
            return 7;
        }
        ...
        private static readonly int gMissingItem = GetMissingItem();
    }
}
