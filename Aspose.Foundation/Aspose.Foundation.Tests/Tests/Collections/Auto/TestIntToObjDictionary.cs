...
{
    /// <summary>
    /// Tests Dictionary&lt;int, object&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestIntToObjDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            IntToObjDictionary<object> dictionary = new IntToObjDictionary<object>();
        ...
        /// </summary>
        private static void TestAddDuplicate(IntToObjDictionary<object> dictionary, int duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            IntToObjDictionary<object>.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(IntToObjDictionary<object> dictionary, IntToObjDictionary<object>.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(IntToObjDictionary<object>.IsNullSubstitute(gFirstValue), Is.False);

            IntToObjDictionary<object> dictionary = new IntToObjDictionary<object>();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(IntToObjDictionary<object>.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(IntToObjDictionary<object>.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            IntToObjDictionary<object> dictionary1 = new IntToObjDictionary<object>();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            IntToObjDictionary<object> dictionary2 = new IntToObjDictionary<object>(dictionary1);
        ...
        private static readonly int gFirstKey = GetFirstKey();
        private static readonly int gSecondKey = GetSecondKey();
