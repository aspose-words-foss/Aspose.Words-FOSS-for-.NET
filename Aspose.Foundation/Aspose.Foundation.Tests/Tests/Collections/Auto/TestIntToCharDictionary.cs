...
{
    /// <summary>
    /// Tests Dictionary&lt;int, char&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestIntToCharDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            IntToCharDictionary dictionary = new IntToCharDictionary();
        ...
        /// </summary>
        private static void TestAddDuplicate(IntToCharDictionary dictionary, int duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            IntToCharDictionary.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(IntToCharDictionary dictionary, IntToCharDictionary.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(IntToCharDictionary.IsNullSubstitute(gFirstValue), Is.False);

            IntToCharDictionary dictionary = new IntToCharDictionary();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(IntToCharDictionary.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(IntToCharDictionary.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            IntToCharDictionary dictionary1 = new IntToCharDictionary();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            IntToCharDictionary dictionary2 = new IntToCharDictionary(dictionary1);
