...
{
    /// <summary>
    /// Tests Dictionary&lt;string, object&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestStringToObjDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            StringToObjDictionary<object> dictionary = new StringToObjDictionary<object>();
        ...
        /// </summary>
        private static void TestAddDuplicate(StringToObjDictionary<object> dictionary, string duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            StringToObjDictionary<object>.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(StringToObjDictionary<object> dictionary, StringToObjDictionary<object>.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(StringToObjDictionary<object>.IsNullSubstitute(gFirstValue), Is.False);

            StringToObjDictionary<object> dictionary = new StringToObjDictionary<object>();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(StringToObjDictionary<object>.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(StringToObjDictionary<object>.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            StringToObjDictionary<object> dictionary1 = new StringToObjDictionary<object>();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            StringToObjDictionary<object> dictionary2 = new StringToObjDictionary<object>(dictionary1);
        ...
        {
            TestCaseSensitiveDictionary(new StringToObjDictionary<object>());
            TestCaseSensitiveDictionary(new StringToObjDictionary<object>(true));
        }

        private static void TestCaseSensitiveDictionary(StringToObjDictionary<object> dictionary)
        {
            ...
            Assert.That(StringToObjDictionary<object>.IsNullSubstitute(dictionary["IЯ"]), Is.True);
            Assert.That(StringToObjDictionary<object>.IsNullSubstitute(dictionary["iЯ"]), Is.True);
        ...
        public void TestCaseInsensitiveDictionary()
        {
            ...
            StringToObjDictionary<object> dictionary = new StringToObjDictionary<object>(false);
            dictionary["Iя"] = gFirstValue;
            dictionary["iя"] = gSecondValue;
            Assert.That(dictionary.Count, Is.EqualTo(1));
            Assert.That(dictionary["Iя"], Is.EqualTo(gSecondValue));
