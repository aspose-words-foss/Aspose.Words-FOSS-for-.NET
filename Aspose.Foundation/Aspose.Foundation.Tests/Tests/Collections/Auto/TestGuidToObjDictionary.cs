...
{
    /// <summary>
    /// Tests Dictionary&lt;Guid, object&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestGuidToObjDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            GuidToObjDictionary<object> dictionary = new GuidToObjDictionary<object>();
        ...
        /// </summary>
        private static void TestAddDuplicate(GuidToObjDictionary<object> dictionary, Guid duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            GuidToObjDictionary<object>.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(GuidToObjDictionary<object> dictionary, GuidToObjDictionary<object>.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(GuidToObjDictionary<object>.IsNullSubstitute(gFirstValue), Is.False);

            GuidToObjDictionary<object> dictionary = new GuidToObjDictionary<object>();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(GuidToObjDictionary<object>.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(GuidToObjDictionary<object>.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            GuidToObjDictionary<object> dictionary1 = new GuidToObjDictionary<object>();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            GuidToObjDictionary<object> dictionary2 = new GuidToObjDictionary<object>(dictionary1);
