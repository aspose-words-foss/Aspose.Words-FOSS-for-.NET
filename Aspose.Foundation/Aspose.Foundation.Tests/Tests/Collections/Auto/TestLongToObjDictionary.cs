...
{
    /// <summary>
    /// Tests Dictionary&lt;long, object&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestLongToObjDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            LongToObjDictionary<object> dictionary = new LongToObjDictionary<object>();
        ...
        /// </summary>
        private static void TestAddDuplicate(LongToObjDictionary<object> dictionary, long duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            LongToObjDictionary<object>.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(LongToObjDictionary<object> dictionary, LongToObjDictionary<object>.Enumerator enumerator)
        {
            long[] keys = new long[dictionary.Count];
        ...
        public void TestEnumeratorGetKeyWithoutMove()
        {
            LongToObjDictionary<object> dictionary = new LongToObjDictionary<object>();
            LongToObjDictionary<object>.Enumerator enumerator = dictionary.GetEnumerator();
            long key = enumerator.CurrentKey;
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(LongToObjDictionary<object>.IsNullSubstitute(gFirstValue), Is.False);

            LongToObjDictionary<object> dictionary = new LongToObjDictionary<object>();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(LongToObjDictionary<object>.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(LongToObjDictionary<object>.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            LongToObjDictionary<object> dictionary1 = new LongToObjDictionary<object>();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            LongToObjDictionary<object> dictionary2 = new LongToObjDictionary<object>(dictionary1);
        ...
        /// </summary>
        private static long GetFirstKey()
        {
            return 1L;
        }
        ...
        /// </summary>
        private static long GetSecondKey()
        {
            return 2L;
        }
        ...
        private static readonly long gFirstKey = GetFirstKey();
        private static readonly long gSecondKey = GetSecondKey();
