...
{
    /// <summary>
    /// Tests Dictionary&lt;int, int&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestIntToIntDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            IntToIntDictionary dictionary = new IntToIntDictionary();
        ...
        /// </summary>
        private static void TestAddDuplicate(IntToIntDictionary dictionary, int duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            IntToIntDictionary.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(IntToIntDictionary dictionary, IntToIntDictionary.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(IntToIntDictionary.IsNullSubstitute(gFirstValue), Is.False);

            IntToIntDictionary dictionary = new IntToIntDictionary();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(IntToIntDictionary.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(IntToIntDictionary.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            IntToIntDictionary dictionary1 = new IntToIntDictionary();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            IntToIntDictionary dictionary2 = new IntToIntDictionary(dictionary1);
