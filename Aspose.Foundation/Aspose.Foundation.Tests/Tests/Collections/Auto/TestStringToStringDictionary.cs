...
{
    /// <summary>
    /// Tests Dictionary&lt;string, string&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestStringToStringDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            StringToStringDictionary dictionary = new StringToStringDictionary();
        ...
        /// </summary>
        private static void TestAddDuplicate(StringToStringDictionary dictionary, string duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            StringToStringDictionary.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(StringToStringDictionary dictionary, StringToStringDictionary.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(StringToStringDictionary.IsNullSubstitute(gFirstValue), Is.False);

            StringToStringDictionary dictionary = new StringToStringDictionary();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(StringToStringDictionary.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(StringToStringDictionary.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            StringToStringDictionary dictionary1 = new StringToStringDictionary();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            StringToStringDictionary dictionary2 = new StringToStringDictionary(dictionary1);
        ...
        {
            TestCaseSensitiveDictionary(new StringToStringDictionary());
            TestCaseSensitiveDictionary(new StringToStringDictionary(true));
        }

        private static void TestCaseSensitiveDictionary(StringToStringDictionary dictionary)
        {
            ...
            Assert.That(StringToStringDictionary.IsNullSubstitute(dictionary["IЯ"]), Is.True);
            Assert.That(StringToStringDictionary.IsNullSubstitute(dictionary["iЯ"]), Is.True);
        ...
        public void TestCaseInsensitiveDictionary()
        {
            ...
            StringToStringDictionary dictionary = new StringToStringDictionary(false);
            dictionary["Iя"] = gFirstValue;
            dictionary["iя"] = gSecondValue;
            Assert.That(dictionary.Count, Is.EqualTo(1));
            Assert.That(dictionary["Iя"], Is.EqualTo(gSecondValue));
