...
{
    /// <summary>
    /// Tests Dictionary&lt;object, int&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestObjToIntDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            ObjToIntDictionary<object> dictionary = new ObjToIntDictionary<object>();
        ...
        /// </summary>
        private static void TestAddDuplicate(ObjToIntDictionary<object> dictionary, object duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            ObjToIntDictionary<object>.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(ObjToIntDictionary<object> dictionary, ObjToIntDictionary<object>.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(ObjToIntDictionary<object>.IsNullSubstitute(gFirstValue), Is.False);

            ObjToIntDictionary<object> dictionary = new ObjToIntDictionary<object>();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(ObjToIntDictionary<object>.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(ObjToIntDictionary<object>.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            ObjToIntDictionary<object> dictionary1 = new ObjToIntDictionary<object>();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            ObjToIntDictionary<object> dictionary2 = new ObjToIntDictionary<object>(dictionary1);
