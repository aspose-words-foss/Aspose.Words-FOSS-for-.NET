...
{
    /// <summary>
    /// Tests Dictionary&lt;long, bool&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestLongToBoolDictionary
    {
        /// <summary>
        ...
        /// </summary>
        private static void TestAddDuplicate(LongToBoolDictionary dictionary, long duplicateKey)
        {
            try
            {
        ...
        /// </summary>
        private static void TestEnumerator(LongToBoolDictionary dictionary, LongToBoolDictionary.Enumerator enumerator)
        {
            long[] keys = new long[dictionary.Count];
            bool[] values = new bool[dictionary.Count];
            int index = 0;
        ...
        public void TestEnumeratorGetValueWithoutMove()
        {
            LongToBoolDictionary dictionary = new LongToBoolDictionary();
            LongToBoolDictionary.Enumerator enumerator = dictionary.GetEnumerator();
            bool value = enumerator.CurrentValue;
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(LongToBoolDictionary.IsNullSubstitute(gFirstValue), Is.False);

            LongToBoolDictionary dictionary = new LongToBoolDictionary();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(LongToBoolDictionary.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(LongToBoolDictionary.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            LongToBoolDictionary dictionary1 = new LongToBoolDictionary();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            LongToBoolDictionary dictionary2 = new LongToBoolDictionary(dictionary1);
        ...
        /// </summary>
        private static bool GetFirstValue()
        {
            return true;
        }
        ...
        /// </summary>
        private static bool GetSecondValue()
        {
            return false;
        }
        ...
        private static readonly bool gFirstValue = GetFirstValue();
        private static readonly bool gSecondValue = GetSecondValue();
    }
}
