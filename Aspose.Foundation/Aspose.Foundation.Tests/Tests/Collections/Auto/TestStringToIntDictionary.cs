...
{
    /// <summary>
    /// Tests Dictionary&lt;string, int&gt; class' functionality.
    /// </summary>
    [TestFixture]
    public class TestStringToIntDictionary
    {
        /// <summary>
        ...
        public void TestAdd()
        {
            StringToIntDictionary dictionary = new StringToIntDictionary();
        ...
        /// </summary>
        private static void TestAddDuplicate(StringToIntDictionary dictionary, string duplicateKey)
        {
            try
            {
        ...
        public void TestEnumerator()
        {
            ...
            StringToIntDictionary.Enumerator enumerator = dictionary.GetEnumerator();
        ...
        /// </summary>
        private static void TestEnumerator(StringToIntDictionary dictionary, StringToIntDictionary.Enumerator enumerator)
        {
        ...
        public void TestNullSubstitute()
        {
            ...
            Assert.That(StringToIntDictionary.IsNullSubstitute(gFirstValue), Is.False);

            StringToIntDictionary dictionary = new StringToIntDictionary();
            dictionary.Add(gFirstKey, gFirstValue);
            Assert.That(StringToIntDictionary.IsNullSubstitute(dictionary[gFirstKey]), Is.False);
            Assert.That(StringToIntDictionary.IsNullSubstitute(dictionary[gSecondKey]), Is.True);
        }
        ...
        {
            StringToIntDictionary dictionary1 = new StringToIntDictionary();
            dictionary1[gFirstKey] = gFirstValue;
            dictionary1[gSecondKey] = gSecondValue;

            StringToIntDictionary dictionary2 = new StringToIntDictionary(dictionary1);
        ...
        {
            TestCaseSensitiveDictionary(new StringToIntDictionary());
            TestCaseSensitiveDictionary(new StringToIntDictionary(true));
        }

        private static void TestCaseSensitiveDictionary(StringToIntDictionary dictionary)
        {
            ...
            Assert.That(StringToIntDictionary.IsNullSubstitute(dictionary["IЯ"]), Is.True);
            Assert.That(StringToIntDictionary.IsNullSubstitute(dictionary["iЯ"]), Is.True);
        ...
        public void TestCaseInsensitiveDictionary()
        {
            ...
            StringToIntDictionary dictionary = new StringToIntDictionary(false);
            dictionary["Iя"] = gFirstValue;
            dictionary["iя"] = gSecondValue;
            Assert.That(dictionary.Count, Is.EqualTo(1));
            Assert.That(dictionary["Iя"], Is.EqualTo(gSecondValue));
