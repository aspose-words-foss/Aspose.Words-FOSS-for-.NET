...
namespace Aspose.Words.Tests.Unified
{
    ...
    public class TestTables : UnifiedTestsBase
    {
        ...
        public void Test23670()
        {
            ...
            // FOSS The grid re-calculation that kept "width before" in percent units is removed.
            // The grid calculation from cell widths stores the value in twips.
            PreferredWidth widthBefore = (PreferredWidth)table.Rows[1].TablePr[TableAttr.WidthBefore];
            Assert.That(widthBefore.IsFixed, Is.True);
            Assert.That(widthBefore.ValueTwips, Is.EqualTo(13));
        }
