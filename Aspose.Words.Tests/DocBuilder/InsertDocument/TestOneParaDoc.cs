...
namespace Aspose.Words.Tests.DocBuilder.InsertDocument
{
    ...
    /// Tests insertion of document with only single paragraph.
    /// </summary>
    [TestFixture]
    public class TestOneParaDoc : TestInsertDocumentBase
    {
        /// <summary>
        ...
        public void TestListParaBefore()
        {
            ...
            {
                TestInsertDocument(TestInsertSrcDocType.OneParaDoc, location);
