...
namespace Aspose.Words.Tests.DocBuilder.InsertDocument
{
    ...
    /// Tests insertion of document with multiple columns.
    /// </summary>
    [TestFixture]
    public class TestMultiColumnDoc : TestInsertDocumentBase
    {
        /// <summary>
        ...
        public void TestListParaBefore()
        {
            ...
            {
                TestInsertDocument(TestInsertSrcDocType.MultiColumnDoc, location);
