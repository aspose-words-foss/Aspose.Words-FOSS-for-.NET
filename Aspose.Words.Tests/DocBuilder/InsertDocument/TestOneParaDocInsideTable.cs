...
namespace Aspose.Words.Tests.DocBuilder.InsertDocument
{
    ...
    /// Tests insertion of document with single paragraph inside table.
    /// </summary>
    [TestFixture]
    public class TestOneParaDocInsideTable : TestInsertDocumentBase
    {
        /// <summary>
        ...
        public void TestListParaBefore()
        {
            ...
            {
                TestInsertDocument(TestInsertSrcDocType.OneParaDocInsideTable, location);
