...
{
    /// <summary>
    /// Unit tests for different RomanDotTxtNumberingStyle (Lowercase, Uppercase)
    /// </summary>
    [TestFixture]
    public class TestRomanDotTxtNumberingStyle
    {
        [TestFixtureSetUp]
        public void SetUp()
        {
            mNumberingStyleLower = new LowercaseRomanDotTxtNumberingStyle();
            mNumberingStyleUpper = new UppercaseRomanDotTxtNumberingStyle();
        }
